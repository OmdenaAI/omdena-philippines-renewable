  ...
  return (
    <div className="research-tab px-1">
      ...
      <p>
        ...
        <span className="text-primary">{data.municipality}</span>. Based on our
        estimates, there are approximately{" "}
        <span className="text-primary">[DATA] households & settlements</span> in
        the area.
      </p>
      <p>
      ...
      <p>
        Considering [COMPUTE] kWh is needed in order to have a continuous supply
        of electricity throughout the day, there is a deficit of nearly
        [COMPUTE] kWH.
      </p>
      ...
      <p>
        ...
        of <span className="text-primary">{data.municipality}</span>. By having
        a solar microgrid, <span className="text-primary">[DATA] kWh</span> of
        energy could supply the [DATA] households in the area.
      </p>
      <p>
        Additionally, using solar could also save us [COMPUTE] tons of CO2
        emissions and
        <span className="text-primary">[DATA]</span> months in installation time
        compared to other energy sources. Providing enough power will hasten
